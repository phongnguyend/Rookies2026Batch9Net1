import { LookupAssetsRequest } from "@/features/Assets/assets.types";
import { useReducer } from "react";

const DEFAULT_PARAM: LookupAssetsRequest = {
  pageNumber: 1,
  pageSize: 10,
};
...
export function useAssetsLookupTableState() {
