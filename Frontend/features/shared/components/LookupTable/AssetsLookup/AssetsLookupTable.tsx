...
import { useAssetsLookupTableState } from "./useAssetsLookupTableState";
import SingleSortDataTable, { SortItem } from "../../SingleSortDataTable";
import { SortDirection } from "@/lib/api/base.types";
import { useLookupAssetsQuery } from "@/features/Assets/assets.api";
...
export interface AssetsLookupTableProps {
  isOpen: boolean;
  onClose: () => void;
...
export const AssetsLookupTable = ({
  isOpen,
  onClose,
  onConfirm,
  onCancel,
