...
export default function TestPage() {
  ...
  const [isModalYesAndNoOpen, setIsModalYesAndNoOpen] = useState(false);

  // Test ing purpose only, like isLoading when calling from API
  ...
  return (
    <div className="min-h-screen bg-white text-[#333]">
        ...
        <main className="flex-1 px-32 pt-24">
          ...
          <div className="mb-6 mt-4 flex items-center justify-between">
            ...
            <div className="flex gap-8">
              ...
              <button
                onClick={() => setIsModalYesAndNoOpen(true)}
                className="rounded border border-primary px-5 py-2 font-semibold text-primary hover:bg-primary/5 transition-colors duration-150"
              >
                Test Yes and No
              </button>
      ...
      <ConfirmModal
        isOpen={isModalYesAndNoOpen}
        onClose={() => setIsModalYesAndNoOpen(false)}
        title="Are you sure?"
        body={
          <div>
            <p className="mb-2">Do you want to create a returning request for this asset</p>
            <p className="text-sm text-red-500 font-semibold">Warning: This action is permanent and cannot be undone.</p>
          </div>
        }
        yesButtonLabel="Yes"
        noButtonLabel='No'
        ...
        onYes={() => {
          ...
          setTimeout(() => {
            setIsDeleting(false);
            setIsModalYesAndNoOpen(false);
            console.log("Request returning successfully!");
          }, 1500);
        }}
        onNo={() => {
          setIsModalYesAndNoOpen(false);
          console.log("Decline Request returning!");
        }}
      />
